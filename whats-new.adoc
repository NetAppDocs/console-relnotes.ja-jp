...
この機能を使用するには、link:https://docs.netapp.com/us-en/storage-management-fsx-ontap/use/task-replicate-data.html["レプリケーション関係を作成する"]ユースケースとして*Migration*を選択します。移行プロセスを完了するには、link:https://review.docs.netapp.com/us-en/workload-fsx-ontap/task/replicate-data.html#cut-over-replication-for-migration-use-cases["ストレージVMとその複製ボリュームをカットオーバーする"]データとStorage VM構成設定をターゲットのFSx for ONTAPファイルシステムに永続的に移行する必要があります。
