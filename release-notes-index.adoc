...
summary: NetApp Consoleの管理とストレージ機能、およびNetAppデータ サービスのリリース ノートの完全セットを表示します。 
---
= リリースノートのインデックス
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
NetApp Consoleの機能とNetAppデータ サービスのリリース ノートの完全セットを表示します。
...
* https://docs.netapp.com/us-en/netapp-automation/about/whats-new.html["オートメーションカタログ"^]
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html["NetApp ConsoleでのCloud Volumes ONTAP管理"^]
...
* https://docs.netapp.com/us-en/data-services-data-classification/whats-new.html["データ分類"^]
